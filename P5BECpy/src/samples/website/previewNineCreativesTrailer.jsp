<html lang="en">
  ...
  <!-------------*************** import sdk ***************--------------->
  <script type='text/javascript' 
    src='https://static-na.payments-amazon.com/OffAmazonPayments'removed for security''>
  </script>
  <!-------------*************** gets access token ***************--------------->
  <script type='text/javascript'>
...
<iframe src="//player.vimeo.com/video/102052039" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><p></p>
				  </div>
				</div>
				<!-- /HTML5 Video Player  ================================================== -->
			  </div><!-- /item active --> 
 ...
 <div class="container ">
  ...
  <h3><span style="color:#000">Newstream Trailer &amp; Summary</span></h3>
    ...
    <div class="col-md-3">
      ...
      <p><a href="NineCreatives.jsp"  > <img src="http://crowdne.ws/assets/img/icons/amazonSubscribeButton.gif" width="151" height="43" alt="Pay with Amazon" ></a></p>
       </div>
      <!-- /Subscribe -->
</div>
...
<!-- Modal Stream Subscribe 
    ================================================== -->
  <div class="container" align="center">
   <div id="streamSubscribe" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><!-- .modal -->  
    <div class="modal-dialog"> <!-- .modal-dialogue -->
     <div class="modal-content" >  <!-- .modal-content -->
       <div class="modal-header">  <!-- .modal-header -->
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">CrowdNews Partners with Amazon</h4>
       </div>   <!-- /.modal-header -->
        <div class="modal-body">  <!-- .modal-body -->
         <p class="lead">Coming soon: sign in and pay with your Amazon.com account.</p> 
         
                            <div class="sthumbnail">
                                <a href="ProcessPayment.jsp">   <img src="http://crowdne.ws/assets/img/posterShots/markSteelPosterShot.jpg"></a>
                                <p class="lead" style="padding-top:28px;"><a href="ProcessPayment.jsp"><b>Nine Creatives on Creativity</b></a></p>

                                <p>By clicking the above link you agree to our Beta Terms of Service. <br>Full terms can be found at <a href=" http://web.crowdne.ws/privateBetaTOS.html">CrowdNews Beta  Terms of Service</a></p>
                                <hr>
                                <script>
...
<!--
         <div class="sthumbnail">
         <img src="http://crowdne.ws/assets/img/icons/signInAmazonWindow.png" width="567" height="395">         
         <hr>-->
...
<script src="http://crowdne.ws//assets/js/bootstrap-typeahead.js"></script> 
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-521e219e7f1e9404"></script>
